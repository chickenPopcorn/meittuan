...
export const menuInfo = [
    { title: 'Dining', icon: require('./img/home/icon_homepage_food_category.png') },
    { title: 'Movies', icon: require('./img/home/icon_homepage_movie_category.png') },
    { title: 'Hotel', icon: require('./img/home/icon_homepage_hotel_category.png') },
    { title: 'KTV', icon: require('./img/home/icon_homepage_ktv_category.png') },
    { title: 'Discount', icon: require('./img/home/icon_homepage_default.png') },
    { title: 'Tour', icon: require('./img/home/icon_homepage_foottreat_category.png') },
    { title: 'Service', icon: require('./img/home/icon_homepage_life_service_category.png') },
    { title: 'Fun', icon: require('./img/home/icon_homepage_entertainment_category.png') },
    { title: 'Beauty', icon: require('./img/home/icon_homepage_beauty_category.png') },
    { title: 'shopping', icon: require('./img/home/icon_homepage_shopping_category.png') },
